...
_G.packer_plugins = {
  ...
  ["distant.nvim"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/distant.nvim",
  ...
  orgmode = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/orgmode",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["vim-test"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/vim-test",
    url = "https://github.com/vim-test/vim-test"
  },
  ["vim-ultest"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/vim-ultest",
